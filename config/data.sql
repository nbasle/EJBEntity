...
INSERT INTO T_ADDRESS (id, street1, street2, city, state, zipcode, country) VALUES ('10900', '65 Ritherdon Road', '', 'Los Angeles', 'LA', '56421', 'USA');
INSERT INTO T_ADDRESS (id, street1, street2, city, state, zipcode, country) VALUES ('10901', '154 Star Boulevard', '', 'San Francisco', 'WC', '5455', 'USA');

INSERT INTO T_CREDIT_CARD (id, creditCardNumber, creditCardType, creditCardExpiryDate) VALUES ('10800', '1234 1234 4561 2132', 'VISA', '10/08');

INSERT INTO T_CUSTOMER (id, password, firstname, lastname, email, telephone, creditCard_fk, address_fk) VALUES ('marc123', 'marc123', 'Marc', 'Fleury', 'marc@fleury.com', '545 123 45', '10800', '10900');
INSERT INTO T_CUSTOMER (id, password, firstname, lastname, email, telephone, creditCard_fk, address_fk) VALUES ('bill000', 'bill000', 'Bill', 'Gates', '', '654 046 12', null, null);
INSERT INTO T_CUSTOMER (id, password, firstname, lastname, email, telephone, creditCard_fk, address_fk) VALUES ('job5', 'job5', 'Steve', 'Jobs', 'steve@jobs.com', '548 157 15', null, 10901);
