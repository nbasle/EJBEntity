...
public final class CatalogDelegateTest extends AbstractTestCase {
    ...
    private void updateCategory(final CategoryDTO categoryDTO, final String id) throws CheckException, RemoteException {
    ...
    private void updateProduct(final ProductDTO productDTO, final String id) throws CheckException, RemoteException, CreateException {
        // Create Category
        final CategoryDTO categoryDTO = new CategoryDTO("cat" + id, "name" + id, "description" + id);
        CatalogDelegate.createCategory(categoryDTO);
    ...
    private void updateItem(final ItemDTO itemDTO, final String id) throws CheckException, RemoteException, CreateException {
        // Create Category
        final CategoryDTO categoryDTO = new CategoryDTO("cat" + id, "name" + id, "description" + id);
        CatalogDelegate.createCategory(categoryDTO);
        // Create Product
