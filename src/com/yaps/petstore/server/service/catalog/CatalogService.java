...
public interface CatalogService extends EJBObject {
     ...
     * @throws RemoteException is thrown if a remote call fails
     */
    void updateCategory(CategoryDTO categoryDTO) throws CheckException, RemoteException;
     ...
     * @throws RemoteException is thrown if a remote call fails
     */
    void updateProduct(ProductDTO productDTO) throws CheckException, RemoteException;
     ...
     * @throws RemoteException         is thrown if a remote call fails
     */
    Collection findProducts(String categoryId) throws FinderException, CheckException, RemoteException;
     ...
     * @throws RemoteException is thrown if a remote call fails
     */
    void updateItem(ItemDTO itemDTO) throws CheckException, RemoteException;
     ...
     * @throws RemoteException         is thrown if a remote call fails
     */
    Collection findItems(String productId) throws FinderException, CheckException, RemoteException;
