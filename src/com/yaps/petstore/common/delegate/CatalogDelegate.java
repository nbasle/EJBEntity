...
public final class CatalogDelegate {
     ...
     */
    public static void updateCategory(final CategoryDTO categoryDTO) throws CheckException, RemoteException {
     ...
     */
    public static void updateProduct(final ProductDTO productDTO) throws CheckException, RemoteException {
     ...
     */
    public static void updateItem(final ItemDTO item) throws CheckException, RemoteException {
